...
GRANT ALL PRIVILEGES ON `IU2022test`.* TO `iu2022user`@`localhost` WITH GRANT OPTION;

--
-- Base de datos: `IU2022`
--
DROP DATABASE IF EXISTS `IU2022test`;
CREATE DATABASE IF NOT EXISTS `IU2022test` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `IU2022test`;
...
(1, 'persona', 'Gestión de personas'),
(2, 'usuario', 'Gestión de usuarios'),
(3, 'rol', 'Gestión de roles'),
(4, 'funcionalidad', 'Gestión de funcionalidades'),
(5, 'accion', 'Gestión de acciones'),
(6, 'rolaccionfuncionalidad', 'Gestión de Rol_Acción_Funcionalidad'),
(7, 'auth', 'Funcionalidad que contiene las acciones de login, registrar, recuperar y desconectar'),
(8, 'funcionalidadaccion','Acciones posibles en funcionalidades');
...
CREATE TABLE `log` (
  ...
  `controlador` varchar(200) COLLATE utf8_bin NOT NULL,
  `action` varchar(200) COLLATE utf8_bin NOT NULL,
  `query` varchar(200) COLLATE utf8_bin NOT NULL,
  `codigorespuesta` varchar(200) COLLATE utf8_bin NOT NULL,
...
(1, 'comprador', 'Rol destinado a la reserva de productos de los vendedores'),
(2, 'vendedor', 'Rol destinado a la publicación de productos dentro de los escaparates de las tiendas'),
(3, 'administrador', 'Rol que dispone de todas las funcionalidades de usuario y vendedor'),
(4, 'superadministrador', 'Rol que posee todas las funcionalidades de administrador y la gestión de estos');
